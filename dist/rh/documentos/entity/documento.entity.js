...
let DocumentoEntity = class DocumentoEntity extends commonEntity_abstract_1.CommonEntity {
};
__decorate([
    typeorm_1.Column({
        type: 'tinytext',
...
__decorate([
    ...
    __metadata("design:type", String)
], DocumentoEntity.prototype, "fileName", void 0);
DocumentoEntity = __decorate([
    typeorm_1.Entity('documentos')
], DocumentoEntity);
