...
const morganTypes_enum_1 = require("./common/enum/morganTypes.enum");
const Joi = require("@hapi/joi");
exports.AppConfig = {
    validationSchema: Joi.object({
        ENABLE_SYSLOG: Joi.boolean().default(true),
        MORGAN_TYPE: Joi.string().default(morganTypes_enum_1.MorganTypes.COMBINED),
        NODE_ENV: Joi.string()
        ...
        WACHABOT_URL: Joi.string().default('https://app.wachatbot.com:12345/api/message/send'),
        WACHABOT_PREFIX: Joi.string().default('+52'),
        WACHABOT_EMPRESA: Joi.string().default('Laboratorio Clínico San Francisco'),
    }),
    validationOptions: {
        allowUnknown: true,
        abortEarly: true,
